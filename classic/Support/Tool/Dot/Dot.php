...
class Dot
{
    ...
    {
        $tmp = static::find($array, $key, []);
        array_push($tmp, $value);
        static::set($array, $key, $tmp);
    }
    ...
    {
        $value = static::find($array, $key, $default);
     ...
     * @return array
     */
    public static function smooth($value): array
    {
        ...
        return SmoothCommand::execute($value);
    }
